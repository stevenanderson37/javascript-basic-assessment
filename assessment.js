...
// Jasmine Spec Runner was expecting to see 'Superman' and 'Batman' stored in their own variables as strings, not as a string in an array. That's what was causing problems. Additionally, the 'flash' part of the problem wasn't even checked for in Jasmine.
...
function doubleTheFun(para) {
	...
	return para;
		...
		// This works exactly as it asks it to work, but I still cannot get Jasmine to say it is correct. It keeps saying, "Expected 4 to equal 5." WHAT?!!!
		// The number 2.5 works (= 5), but the string '2.5' doesn't (= 4).
		// Changing the parseInt to parseFloat fixes the problem with the decimals inside of strings. parseFloat works with decimals while parseInt does NOT.
		// FOR TESTING https://repl.it/DhRb/1
